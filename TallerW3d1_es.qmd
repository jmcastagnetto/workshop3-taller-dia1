...
```
 ...
 La métrica de validez para la variable fecha resultado en el conjunto de datos positivos (casos positivos) corresponde al `r round(validez_fecha_resultado,2)`% de fechas con un formato incorrecto que debe ser coregido.
